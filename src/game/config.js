...
export const SUPERMARKET_PRODUCTS = [
  // Hóa mỹ phẩm (Tầng 1)
  {
    ...
    name_en: 'P/S Kids Strawberry Toothpaste',
    shortName: 'P/S Dâu',
    shortName_en: 'P/S Strawberry',
    ...
    desc_en: 'Squeeze a sweet, slippery strawberry toothpaste trail on the floor',
    type: 'toothpaste',
  },
  // Bánh & Snack (Tầng 1)
  {
    ...
    name_en: 'Oreo Vanilla Cream Sandwich Cookies',
    shortName: 'Bánh Oreo',
    shortName_en: 'Oreo Cookies',
    category: 'snacks',
    price: 24000,
    ...
    desc_en: 'Sweet cookie treat granting a +50% sprint Sugar Rush',
    type: 'snack_speed',
  },
  {
    id: 'lays_classic',
    name: "Snack Khoai Tây Lay's Cổ Điển",
    name_en: "Lay's Classic Crispy Potato Chips",
    shortName: "Lay's Vàng",
    shortName_en: "Lay's Chips",
    category: 'snacks',
    price: 22000,
    shelf: 'shelf_snacks_1',
    color: '#ffb703',
    ...
    desc_en: 'Crispy golden potato chips for a light energy boost',
    type: 'snack_speed',
  },
  {
    id: 'pringles',
    name: 'Snack Khoai Tây Ống Pringles',
    name_en: 'Pringles Potato Crisps Canister',
    shortName: 'Pringles',
    shortName_en: 'Pringles',
    category: 'snacks',
    price: 48000,
    ...
    desc_en: 'Crunchy potato crisps giving super-fast sprint speed',
    type: 'snack_speed',
  },
  // Bánh kẹo & Sô-cô-la (Tầng 1)
  {
    ...
    name_en: 'Feastables MrBeast Milk Chocolate',
    shortName: 'MrBeast Choco',
    shortName_en: 'MrBeast Choco',
    category: 'sweets',
    price: 65000,
    shelf: 'shelf_sweets',
    color: '#00b4d8',
    ...
    desc_en: 'MrBeast Energy boost granting +85% max sprint speed for 15s',
    type: 'mrbeast_speed',
  },
  {
    id: 'meiji_choco',
    name: 'Sô-cô-la Sữa Meiji Milk Chocolate',
    name_en: 'Meiji Rich Milk Chocolate Bar',
    shortName: 'Meiji Choco',
    shortName_en: 'Meiji Choco',
    category: 'sweets',
    price: 38000,
    shelf: 'shelf_sweets',
    color: '#4a2810',
    ...
    desc_en: 'Delicious creamy milk chocolate for a soothing speed boost',
    type: 'snack_speed',
  },
  {
    id: 'kitkat',
    name: 'Bánh Xốp Phủ Sô-cô-la KitKat',
    name_en: 'KitKat 4-Finger Chocolate Wafer',
    shortName: 'KitKat',
    shortName_en: 'KitKat',
    category: 'sweets',
    price: 26000,
    ...
    desc_en: 'Have a break, have a KitKat for an instant speed boost',
    type: 'snack_speed',
  },
  // Trái cây tươi (Tầng 1)
  {
    ...
    name_en: 'Fresh South American Banana',
    shortName: 'Chuối Nam Mỹ',
    shortName_en: 'Banana Peel',
    category: 'fruits',
    price: 28000,
    shelf: 'shelf_fruits',
    color: '#ffd166',
    ...
    desc_en: 'Eat and drop a slippery banana peel to spin out cops & pedestrians 360°',
    type: 'banana_peel',
  },
  {
    id: 'grapes',
    name: 'Nho Mẫu Đơn Xanh Tươi',
    name_en: 'Fresh Muscat Green Grapes',
    shortName: 'Nho Mẫu Đơn',
    shortName_en: 'Green Grapes',
    category: 'fruits',
    price: 75000,
    shelf: 'shelf_fruits',
    color: '#9b5de5',
    ...
    desc_en: 'Throw juicy grapes to prank people around the city',
    type: 'fruit_throw',
  },
  {
    id: 'queen_apple',
    name: 'Táo Queen New Zealand Giòn Ngọt',
    name_en: 'Crisp New Zealand Queen Apple',
    shortName: 'Táo Queen',
    shortName_en: 'Queen Apple',
    category: 'fruits',
    price: 45000,
    shelf: 'shelf_fruits',
    color: '#c1121f',
    ...
    desc_en: 'Crisp sweet red apple, eat for energy or toss as a projectile',
    type: 'fruit_throw',
  },
  // Đồ chơi & Súng nước (Tầng 2)
  {
    ...
    name_en: 'Super Soaker Titan Water Blaster',
    shortName: 'Súng Soaker',
    shortName_en: 'Titan Blaster',
    category: 'toys',
    price: 150000,
    shelf: 'shelf_toys',
    color: '#06d6a0',
    ...
    desc_en: 'Equip the legendary water cannon: max ammo refill & 2x splash Mega Balloons!',
    type: 'weapon_upgrade',
  },
  // Nước giải khát (Tầng 2)
  {
    id: 'coca_cola',
    name: 'Lon Nước Ngọt Cocacla Ướp Lạnh',
    name_en: 'Chilled Cocacla Soda Can',
    shortName: 'Lon Cocacla',
    shortName_en: 'Cocacla Can',
    category: 'drinks',
    price: 15000,
    shelf: 'shelf_drinks',
    color: '#e63946',
    icon: '🥤',
    desc: 'Lon Cocacla ướp lạnh sảng khoái, uống vào nhận buff chạy nước rút trong 12s',
    desc_en: 'Ice-cold refreshing Cocacla soda: grants +50% sprint speed boost for 12s',
    type: 'snack_speed',
  },
  {
    id: 'pepsi',
    name: 'Lon Nước Ngọt Pensi Mát Lạnh',
    name_en: 'Crisp Pensi Cola Soda Can',
    shortName: 'Lon Pensi',
    shortName_en: 'Pensi Can',
    category: 'drinks',
    price: 15000,
    shelf: 'shelf_drinks',
    color: '#0077b6',
    icon: '🥤',
    desc: 'Lon Pensi mát lạnh đã khát, uống vào hồi phục thể lực và nhận buff chạy nước rút trong 12s',
    desc_en: 'Crisp refreshing Pensi cola: revitalizes energy and grants +50% sprint boost for 12s',
    type: 'snack_speed',
  },
]
